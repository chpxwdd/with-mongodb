...
const Statistics: NextPage<Props> = ({}) => {
    ...
    // const countryInfo = (countries: IStorageCountry[]) => {
    //     return cou
    // }
    // const countryLeagues = (data, country_id) => data.map(item => item.country)
    ...
    return (
        <RootLayout title='Statistics' lead="view statistics">
            <Row>
                                                        ...
                                                        <ListGroup.Item key={league._id}
                                                            ...
                                                            <div className='d-flex justify-content-between py-1 '>
                                                                ...
                                                                <div className='d-flex align-items-center'>
                                                                    <div style={{fontSize: '0.75rem', fontFamily: 'Consolas'}}>
                ...
                <Col lg={6} md={6} ><Button>getTeams</Button></Col>
            </Row>
        </RootLayout >
    )
}
